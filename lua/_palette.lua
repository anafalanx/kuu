...
scalars = {
  ...
  Version  = { over = "string",
    note = "N.N: two natural numbers, starting with 0.11. Never compared by text: use rt.version_at_least." },
...
errors = {
  ...
  HTTP    = { "timeout", "notfound", "access", "connect", "tls", "toobig", "mismatch",
  ...
  JSON    = { "parse", "duplicate", "depth", "badvalue", "encoding", "usage", "oserror" },
  CSV     = { "parse", "badvalue", "usage" },
  INI     = { "badvalue", "usage" },
  HASH    = { "badvalue", "encoding", "notfound", "access", "closed", "usage", "oserror" },
  TEXT    = { "invalid", "unencodable", "unsupported", "badvalue", "usage", "toobig",
              "oserror" },
  RE      = { "badpattern", "badvalue", "invalid", "limit", "oserror" },
  TIME    = { "badvalue", "usage", "oserror" },
  ARCHIVE = { "notfound", "failed", "badvalue", "usage", "timeout", "encoding", "toobig",
              "oserror" },
  LOG     = { "badvalue", "usage", "oserror" },
  MEM     = { "toobig", "badvalue", "corrupt", "unreadable" },
  SYNC    = { "busy", "badvalue", "oserror", "encoding" },
  SYS     = { "notfound", "access", "badvalue", "usage", "oserror" },
  ...
  EVT     = { "notfound", "access", "badvalue", "usage", "oserror" },
  PTY     = { "usage", "badvalue", "notfound", "encoding", "launch", "busy", "closed",
  ...
  proc = {
    run = { options_at = 1,
      options = { cwd = "string?", env = "table?", timeout = "Duration?",
                  stdin = "string?", maxout = "Size?", inherit = "boolean?", inherit_stdin = "boolean?",
                  limits = "Limits?" },
      result  = "ProcResult",
