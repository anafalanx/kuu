...
local cases = { "entry", "err", "sched", "deadline", "proc", "limits", "pty", "json", "hash", "text", "re", "time", "fs", "paths", "sys", "svc", "evt", "sync", "mem", "log", "cli", "http", "net", "csv", "ini", "reg", "env", "task", "ledger", "archive", "check", "check_corpus", "capabilities", "cookbook", "bundle", "palette", "fixglobals" }
